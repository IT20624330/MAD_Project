...
public class DeliveryList extends AppCompatActivity {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot studentDatasnap : dataSnapshot.getChildren()) {
                    ...
                    Delivery delivery = studentDatasnap.getValue(Delivery.class);
                    user.add(delivery);

                }

                MyAdapter adapter = new MyAdapter(DeliveryList.this, R.layout.custom_food_ordered_deails, (ArrayList<Delivery>) user);
    ...
    class MyAdapter extends ArrayAdapter<Delivery> {
        LayoutInflater inflater;
        Context myContext;
        List<Delivery> user;


        public MyAdapter(Context context, int resource, ArrayList<Delivery> objects) {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            holder.button3.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent mainIntent = new Intent(DeliveryList.this, SelectPaymentMethod.class);
                    DeliveryList.this.startActivity(mainIntent);
                    ...
                    final AlertDialog alertDialog = new AlertDialog.Builder(getContext())
                            ...
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    FirebaseDatabase.getInstance().getReference("Delivery").child(idd).removeValue();
            ...
            holder.button1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final String idd = user.get(position).getId();
                    final DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Delivery").child(idd);
                    ...
                    buttonupdate.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (name.equals("")) {
                                ...
                                Toast.makeText(DeliveryList.this, "Updated successfully", Toast.LENGTH_SHORT).show();
