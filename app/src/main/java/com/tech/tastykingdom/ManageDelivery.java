    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ManageDelivery.this, DeliveryList.class);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                MyAdapter adapter = new MyAdapter(ManageDelivery.this, R.layout.custom_order_items, (ArrayList<OrderDetails>) user);
                            ...
                            buttonAdd.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    if (username.isEmpty()) {
                                        ...
                                        Delivery delivery = new Delivery(id,name, pricee ,finalval,qty,image,username,nic,contact,address);
                                        reference.child(id).setValue(delivery);

                                        Toast.makeText(ManageDelivery.this, "Successfully added", Toast.LENGTH_SHORT).show();
